...
class Container_ extends RefCounted:
	...
	class Builder extends CapnBuilder.StructBuilder:
		...
		func init_boxed_struct() -> Box_Inner.Builder:
			var b: Box_Inner.Builder = Box_Inner.Builder.new()
			self.fill_struct(1, Box_Inner.DATA_WORDS, Box_Inner.PTR_WORDS, b)
			return b

		func init_boxed_list() -> Box_List_Int32.Builder:
			var b: Box_List_Int32.Builder = Box_List_Int32.Builder.new()
			self.fill_struct(2, Box_List_Int32.DATA_WORDS, Box_List_Int32.PTR_WORDS, b)
			return b

		func init_raw_struct(data_words: int, ptr_words: int) -> CapnBuilder.StructBuilder:
			return self.init_struct(3, data_words, ptr_words)

		func init_raw_list(elem_size: CapnPointer.ElemSize, count: int) -> CapnBuilder.ListBuilder:
			return self.init_list(3, elem_size, count)

		func init_raw_composite_list(count: int, data_words: int, ptr_words: int) -> CapnBuilder.ListBuilder:
			return self.init_composite_list(3, count, data_words, ptr_words)
...
class Box_Inner extends RefCounted:
	...
	class Builder extends CapnBuilder.StructBuilder:
		...
		func init_value() -> Inner.Builder:
			var b: Inner.Builder = Inner.Builder.new()
			self.fill_struct(0, Inner.DATA_WORDS, Inner.PTR_WORDS, b)
			return b
...
class Box_List_Int32 extends RefCounted:
	...
	class Builder extends CapnBuilder.StructBuilder:
		...
		func set_value(value: PackedInt32Array) -> void:
			var lb: CapnBuilder.ListBuilder = self.init_list(0, CapnPointer.ElemSize.FOUR_BYTES, value.size())
